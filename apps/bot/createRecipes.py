...
def createRecipe(item, craftRequirements, recipeId, oldRecipe, specializationBranch, craftingCategory):
    return {
        "recipeId": recipeId,
...
for item in items:
    ...
    # Base recipe
    recipes.append(createRecipe(item, craftRequirements, recipeId, oldRecipe, specializationBranch, craftingCategory))
    ...
    for ench in enchantments:
        ...
        recipes.append(createRecipe(item, enchCraftingRequirements, enchRecipeId, oldRecipe, specializationBranch, craftingCategory))
